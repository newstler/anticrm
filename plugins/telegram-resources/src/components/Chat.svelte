...
<script lang="ts">
  ...
  import contact, { Channel, Contact, Employee, PersonAccount, getName as getContactName } from '@hcengineering/contact'
  ...
  $: participants = getParticipants(messages, $personAccountByIdStore, object, $collaboratorByIdStore)
</script>

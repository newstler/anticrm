...
<script lang="ts">
  ...
  import { Avatar, collaboratorByIdStore, EmployeePresenter } from '@hcengineering/contact-resources'
  ...
  $: employee = empRef !== undefined ? $collaboratorByIdStore.get(empRef) : undefined

...
@Mixin(contact.mixin.Collaborator, contact.class.Person)
@UX(contact.string.Collaborator, contact.icon.Person, 'COL', 'name')
export class TCollaborator extends TPerson implements Collaborator {}
